...
export const BottomNav: React.FC = () => {
  ...
  return (
    <div className={`md:hidden fixed bottom-4 left-4 right-4 bg-white/95 backdrop-blur-2xl border border-gray-100 z-50 px-6 py-3 flex items-center ${user ? 'justify-between' : 'justify-center gap-12'} rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.08)]`}>
