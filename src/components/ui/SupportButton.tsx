...
export const SupportButton: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: 'مرحباً بك في عالم التجارة الآمنة.. أنا مرشدك في منصة عربون. أستطيع أن أروي لك كيف نحمي معاملاتك المالية، أو أدلك على طريق التوثيق الاحترافي. كيف أبدأ رحلتي معك اليوم؟',
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
